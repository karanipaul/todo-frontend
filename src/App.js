				...
				<div className='w-1/2 space-y-2'>
								...
								>
									...
									<div className='flex items-center space-x-2'>
										<input
											...
											checked={todo.done}
										/>
										<button className='px-2 py-1 bg-red-500 hover:bg-red-600 rounded-md text-white'>
					...
					<div className='space-y-2 p-4 bg-white rounded-lg shadow-md'>
						<input
							...
							type='text'
						/>
						<button className='w-full p-2 bg-green-500 hover:bg-green-600 rounded-md shadow-md text-white text-2xl font-bold'>
							Add
						</button>
					</div>
				</div>
